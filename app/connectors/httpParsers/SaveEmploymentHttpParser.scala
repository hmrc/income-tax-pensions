...
object SaveEmploymentHttpParser extends APIParser {
  override val parserName: String = "SaveEmploymentHttpParser"
  override val service: String    = "income-tax-employment"

  implicit object SaveEmploymentHttpReads extends HttpReads[DownstreamErrorOr[Unit]] {
