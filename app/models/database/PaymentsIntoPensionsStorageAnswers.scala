...
final case class PaymentsIntoPensionsStorageAnswers(rasPensionPaymentQuestion: Boolean,
  ...
  def encrypted(implicit aesGCMCrypto: EncryptionService, textAndKey: TextAndKey): EncryptedPaymentsIntoPensionsStorageAnswers =
...
final case class EncryptedPaymentsIntoPensionsStorageAnswers(rasPensionPaymentQuestion: EncryptedValue,
  ...
  protected[database] def unsafeDecrypted(implicit aesGCMCrypto: EncryptionService, textAndKey: TextAndKey): PaymentsIntoPensionsStorageAnswers =
    PaymentsIntoPensionsStorageAnswers(
