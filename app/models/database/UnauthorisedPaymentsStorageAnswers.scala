...
final case class UnauthorisedPaymentsStorageAnswers(surchargeQuestion: Option[Boolean],
  ...
  def encrypted(implicit aesGCMCrypto: EncryptionService, textAndKeyAes: TextAndKey): EncryptedStorageAnswers[UnauthorisedPaymentsStorageAnswers] =
...
final case class EncryptedUnauthorisedPaymentsStorageAnswers(surchargeQuestion: Option[EncryptedValue],
  ...
  protected[database] def unsafeDecrypted(implicit aesGCMCrypto: EncryptionService, textAndKeyAes: TextAndKey): UnauthorisedPaymentsStorageAnswers =
    UnauthorisedPaymentsStorageAnswers(
