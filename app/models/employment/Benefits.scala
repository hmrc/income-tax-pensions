...
final case class Benefits(accommodation: Option[BigDecimal] = None,
...
object Benefits {
  ...
  val secondSetOfFields
      : OFormat[(Option[BigDecimal], Option[BigDecimal], Option[BigDecimal], Option[BigDecimal], Option[BigDecimal], Option[BigDecimal])] = (
