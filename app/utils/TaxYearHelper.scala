...
object TaxYearHelper {
  ...
  private val tysApiOrderedMap: Map[(String, Int), String] = Map(
    (PensionIncomeBaseApi.Update, 2024) -> "1884", (PensionIncomeBaseApi.Get, 2024) -> "1909", (PensionIncomeBaseApi.Delete, 2024) -> "1910",
    (PensionReliefsBaseApi.Update, 2024) -> "1797", (PensionReliefsBaseApi.Get, 2024) -> "1798", (PensionReliefsBaseApi.Delete, 2024) -> "1799",
    (PensionChargesBaseApi.Update, 2024) -> "1868", (PensionChargesBaseApi.Get, 2024) -> "1869", (PensionChargesBaseApi.Delete, 2024) -> "1883"
