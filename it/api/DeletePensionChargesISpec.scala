...
class DeletePensionChargesISpec extends WiremockSpec with ScalaFutures {
  ...
  "delete pension charges" when {
    ...
    "the user is an individual" must {
      ...
      "return 404 if a user has no recorded pension charges to delete" in new Setup {

        val errorResponseBody: String =
          Json.toJson(DesErrorBodyModel("NO_DATA_FOUND", "The remote endpoint has indicated that no data can be found.")).toString()
